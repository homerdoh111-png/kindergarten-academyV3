...
const TreehouseScene = (function() {
    ...
    function createButterflies() {
        ...
        for (let i = 0; i < 12; i++) {
            ...
            butterfly.userData = {
                ...
                speed: 0.15 + Math.random() * 0.2, // Slowed down from 0.3-0.8
    ...
    function animate() {
        ...
        butterflies.forEach(butterfly => {
            ...
            butterfly.position.y = butterfly.userData.height + Math.sin(time * 2 + angle) * 0.5;
            ...
            const flap = Math.sin(time * 5) * 0.4; // Slowed from *10
